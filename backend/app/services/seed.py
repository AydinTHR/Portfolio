    ...
    "experience": [
        {
            ...
            "icon": "◎",
            "description": (
                "Contributed to development of a goalkeeper performance analytics "
                "platform using React frontend and Python/FastAPI backend, built "
                "for competitive soccer teams."
            ),
            "highlights": [
        ...
        },
        {
            ...
            "icon": "◆",
            "description": (
                "Contributed as a Software Engineer Intern on a course management "
                "application for medical and physiotherapy professionals, now in "
                "use across Sweden."
            ),
            "highlights": [
                "Designed 6+ MySQL tables and optimized 12+ queries by adding "
                "composite indexes, reducing average query response time by 30%",
                "Developed 8+ backend API endpoints using Node.js for course "
                "management, authentication, and certificate generation",
                "Collaborated with 3+ developers in an Agile environment, "
        ...
        },
        {
            ...
            "icon": "●",
            "description": (
                "Promoted to Assistant Manager; lead shifts of 4–8 associates and "
                "train 10+ staff in service, operations, and pet-nutrition basics."
            ),
            "highlights": [
                "Consistently ranked #1 in-store for sales per transaction",
                "Standardized opening/closing and weekly inventory cycle counts, "
                "reducing checkout errors",
                "Owned the dog-wash booking pipeline, the basis for the portfolio "
                "project #1",
            ],
        },
    ],
    ...
    "projects": [
        {
            ...
            "description": (
                "An online appointment booking system for Dog Wash services at "
                "PetValu. Features real-time availability, booking management, and "
        ...
        },
        {
            ...
            "description": (
                "A full-stack e-commerce application with product catalog, shopping "
                "cart, secure checkout, and order tracking dashboard."
            ),
        ...
        },
        {
            ...
            "description": (
                "An intelligent conversational assistant powered by machine "
                "learning, featuring natural language understanding and "
